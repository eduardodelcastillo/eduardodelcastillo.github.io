...
var fifthcapital_desc = "Fifth Capital is a wealth management company based in Austin, Texas. Their current website needs a thorough overhaul since it is still using old technologies (eg Flash). With a team of four and after a thorough UX research was done, I was mainly responsible for the visual direction of the website and coding the site in html and css. <br /> <br />Website: www.5thcapital.com <br /> <br /> <a href='http://eduardodelcastillo.github.io/fifth_capital/index.html' target='_blank' class='projectlink'>SEE IT IN ACTION</a>";
var stamplay_desc = "A team of 7 worked on Stamplay's front page in order to develop the story-telling of what the company does. My main role is executing the prototype by coding the front page in html, css and jquery. <br /> <br /> About Stamplay: Stamplay is a webapp that allows people to add back-end functions on their websites without coding by simply integrating one of their built in apis. <br /> <br />Website: www.stamplay.com <br /> <br /><a href='http://eduardodelcastillo.github.io/stamplay/index.html' target='_blank' class='projectlink'>SEE IT IN ACTION</a>";
var twincest_desc = "How does one capture and present the essence of a music band? I did this by listening to all of Twincest's music on soundcloud and youtube in order to capture the spirit and style of the music. I then proposed the colour mood and built the website that I think best portrays their personality. <br /> <br /> <a href='http://eduardodelcastillo.github.io/twincest/index.html' target='_blank' class='projectlink'>SEE IT IN ACTION</a>";
